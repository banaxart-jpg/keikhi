...
- 出力構造（3セクション）:
  - **【ひと言結論】** 見出しレベル 50 字以内・1文。何をやる/やらないかを一読で
  - **【結論】** 500字程度。決定事項・根拠・実行スケジュール (0〜90日 / 12カ月)・KPI・撤退ラインを連続した文章で
  - **【3者の立場の違い / 未解決の論点】** 合意できなかった点 (無ければ「無し」)
- フロントは正規表現で 3 セクションをパースして、ひと言は見出し風大文字・詳細は本文・未解決は補足表示と段組み
